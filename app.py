...
if st.button("Give a Loan"):
    ...
    if "Beeline" in provider_filter:
        ...
        collection_gif.markdown('<img src="https://github.com/DSU-VEON/dashboard/blob/main/collection.gif?raw=true" alt="Alt Text" width=1200 height=1700>', unsafe_allow_html=True)
