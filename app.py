...
if st.button("Give a Loan"):
    ...
    if "Beeline" in provider_filter:
        ...
        scoring_gif.markdown('<img src="https://github.com/DSU-VEON/dashboard/blob/main/scoring.gif?raw=true" alt="Alt Text" width=1600 height=800>', unsafe_allow_html=True)
        ...
        income_gif.markdown('<img src="https://github.com/DSU-VEON/dashboard/blob/main/income.gif?raw=true" alt="Alt Text" width=1600 height=800>', unsafe_allow_html=True)
